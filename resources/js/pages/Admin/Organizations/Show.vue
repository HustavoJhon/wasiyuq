...
<template>
    <div>
        ...
        <div v-if="organization.bio" class="mt-4 text-sm text-muted-foreground">
            {{ organization.bio }}
        </div>

        <div
            v-if="organization.phone || organization.website"
            class="mt-4 flex gap-6 text-sm text-muted-foreground"
        >
        ...
        <div class="mt-6 grid grid-cols-4 gap-4">
            <div
                class="rounded-lg border border-border bg-muted p-4 text-center"
            >
                <p class="text-2xl font-bold text-card-foreground">
                    {{ organization.pets_count }}
                </p>
            ...
            >
                <p class="text-2xl font-bold text-card-foreground">
                    {{ organization.announcements_count }}
                </p>
        ...
        <div class="mt-8">
            ...
            <div
                v-if="organization.pets.length === 0"
            ...
            <div v-else class="mt-3 space-y-2">
                <div
                    v-for="pet in organization.pets"
                    :key="pet.id"
                    class="flex items-center justify-between rounded-lg border border-border/50 px-4 py-3"
                >
                    <div>
