    ...
    <div>
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Artículos publicados por {{ currentTeam?.name }}.
                </p>
            </div>
            <a
                :href="`/${currentTeam?.slug}/blog/crear`"
                    ...
                    >
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                <a
                                    :href="`/${currentTeam?.slug}/blog/${post.id}`"
                                    class="text-xs text-[#2D6A4F] hover:underline"
                                    >Ver</a
                                >
                                <a
                                    :href="`/${currentTeam?.slug}/blog/${post.id}/editar`"
        ...
        <div v-if="meta.last_page > 1" class="mt-6 flex justify-center gap-2">
            <a
                ...
                :key="page"
                :href="`/${currentTeam?.slug}/blog?page=${page}`"
