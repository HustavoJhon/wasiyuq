...
function markCompleted(): void {
    router.post(
        `/${props.currentTeam?.slug}/seguimientos/${props.followUp.id}/completar`,
    );
}

function markMissed(): void {
    router.post(
        `/${props.currentTeam?.slug}/seguimientos/${props.followUp.id}/no-realizado`,
    );
}
    ...
    <div>
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-3">
            <div class="space-y-8 lg:col-span-2">
                ...
                <div
                    v-if="followUp.photos && followUp.photos.length > 0"
            ...
            <div class="space-y-4">
                <div class="rounded-xl border border-border bg-card p-6">
                    ...
                    >
                        ...
                        <button
                            class="w-full rounded-xl border border-amber-200 px-4 py-2.5 text-sm font-medium text-amber-600 transition hover:bg-amber-50"
                            @click="markMissed()"
                        >
                ...
                <div class="rounded-xl border border-border bg-card p-6">
                    ...
                    <button
                        ...
                        class="mt-4 w-full rounded-xl bg-muted px-4 py-2 text-sm font-medium text-muted-foreground transition hover:bg-muted/80"
                    ...
                    <div v-else class="mt-4 space-y-3">
                        ...
                        ></textarea>
                        <button
                            class="w-full rounded-xl bg-[#2D6A4F] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#246142]"
                ...
                <div class="rounded-xl border border-border bg-card p-6">
                    ...
                    <div class="mt-3 space-y-2">
                        ...
                        <p class="text-xs text-muted-foreground/70">
                            {{ followUp.adoption.adopter.email }}
                        </p>
                    </div>
                </div>
            </div>
