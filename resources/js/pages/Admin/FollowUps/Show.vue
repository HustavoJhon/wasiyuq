...
<template>
    <div>
        ...
        >
            ...
            <a
                :href="'/admin/seguimiento/' + followUp.id + '/editar'"
                class="inline-flex items-center gap-2 rounded-lg bg-[#2D6A4F] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#245a40]"
            >
                <svg
                    class="h-4 w-4"
                    fill="none"
