...
const locationSource = ref<'text' | 'maps'>('text');
    ...
    <div class="mx-auto max-w-4xl">
        ...
        <div class="mb-8 mt-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-muted-foreground">Completá los datos para crear un evento o campaña.</p>
                </div>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="grid gap-5">
                    <div class="grid gap-2">
                        ...
                        <div class="relative">
                            ...
                            <Input id="title" v-model="form.title" type="text" placeholder="Ej: Feria de Adopción Primavera 2025" class="pl-9" :disabled="form.processing" />
                        </div>
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select v-model="form.type" name="type">
                            <SelectTrigger class="w-full">
                                <SelectValue placeholder="¿Qué tipo de evento es?" />
                            </SelectTrigger>
                            <SelectContent>
            ...
            <div class="flex items-center gap-4 rounded-2xl border border-[#2D6A4F]/15 bg-gradient-to-b from-white to-[#2D6A4F]/4 p-5 dark:border-[#2D6A4F]/30 dark:from-[#2D6A4F]/15 dark:to-black/40">
                ...
                <a href="/admin/eventos" class="text-sm font-medium text-muted-foreground transition hover:text-foreground">Cancelar</a>
            </div>
        </form>
    </div>
</template>
