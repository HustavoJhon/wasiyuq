...
* @see app/Http/Controllers/Dashboard/EventController.php:83
...
* @see app/Http/Controllers/Dashboard/EventController.php:97
* @route '/{current_team}/eventos/{id}'
*/
...
* @see app/Http/Controllers/Dashboard/EventController.php:119
* @route '/{current_team}/eventos/{id}'
*/
