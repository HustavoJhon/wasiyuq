...
const bottomItems = [
    { href: '/admin/perfil', label: 'Mi Perfil', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
        ...
        >
            ...
            >
                ...
                <Transition name="fade">
                    <span v-if="!collapsed || isMobile" class="text-lg font-bold text-card-foreground whitespace-nowrap">Wasiyuq Admin</span>
                </Transition>
            </div>

            <nav class="flex-1 space-y-1 overflow-y-auto p-3">
                <template v-for="item in navItems" :key="item.href || item.type">
                    <div v-if="item.type === 'divider'" class="my-3 border-t border-border/50" />
                    ...
                    <a
                        ...
                        :class="[
                            ...
                            item.href === '/admin' && !isExactActive('/admin')
                                ? isDashboardActive()
