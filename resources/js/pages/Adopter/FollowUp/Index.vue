        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Historial de seguimiento post-adopción.
                </p>
            </div>
            <a
                href="/mi-adopcion/postulaciones"
        ...
        <div v-else class="mt-8 space-y-6">
            ...
            >
                <div class="flex items-start gap-4 p-5">
                    ...
                    <div
                        v-else
                        class="h-20 w-20 flex-shrink-0 rounded-xl bg-muted"
                    />
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    {{
                                        speciesLabel(fu.adoption.pet.species)
                                    }}
                                    — {{ fu.adoption.team.name }}
                                </p>
                            </div>
                            <span
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            <p class="text-xs text-muted-foreground/70">
                                Programado: {{ formatDate(fu.scheduled_date) }}
                            </p>
                            <a
                                v-if="fu.status === 'pending'"
                                :href="'/mi-adopcion/seguimientos/' + fu.id"
