...
function applyFilter(status: string): void {
    router.get(
        `/${props.currentTeam?.slug}/adopciones`,
        status ? { status } : {},
    );
}
    ...
    <div>
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Revisa y gestiona las postulaciones de
                    {{ currentTeam?.name }}.
                </p>
            </div>
        </div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-border/50">
                    ...
                    >
                        ...
                        <td class="px-5 py-4">
                            <a
                                :href="`/${currentTeam?.slug}/adopciones/${adoption.id}`"
        ...
        <div v-if="meta.last_page > 1" class="mt-6 flex justify-center gap-2">
            <a
                ...
                :key="page"
                :href="`/${currentTeam?.slug}/adopciones?page=${page}`"
