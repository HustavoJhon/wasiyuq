    ...
    <div>
        ...
        <div class="mt-4">
            ...
            <p class="mt-1 text-sm text-muted-foreground">
                Crea un evento o comunicado para {{ currentTeam?.name }}.
            </p>
        </div>
        ...
        <form @submit.prevent="submit" class="mt-6 max-w-lg space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <input
                    ...
                    :disabled="form.processing"
                />
                <p v-if="form.errors.event_date" class="text-xs text-red-500">
            ...
            <div class="space-y-1.5">
                ...
                <input
                    ...
                    :disabled="form.processing"
                />
                <p v-if="form.errors.location" class="text-xs text-red-500">
