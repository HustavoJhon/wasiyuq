        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Informacion de tu cuenta y actividad en la plataforma.
                </p>
            </div>
        </div>
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-3">
            <div class="space-y-6 lg:col-span-2">
                ...
                <div class="rounded-xl border border-border bg-card p-6">
                    ...
                    >
                        No has realizado ninguna adopcion.
                    </p>
                    <div v-else class="mt-4 space-y-3">
                        ...
                        >
                            <div>
                                <a
                                    :href="'/admin/adopciones/' + adoption.id"
                                    class="text-sm font-medium text-card-foreground hover:text-[#2D6A4F]"
                                    >{{ adoption.pet.name }}</a
                                >
                                <p class="text-xs text-muted-foreground">
                                    {{ speciesLabel(adoption.pet.species) }} -
                                    {{ adoption.team.name }}
                                </p>
                            </div>
            ...
            <div class="space-y-6">
                <div class="rounded-xl border border-border bg-card p-6">
                    ...
                    <div
                        v-if="profile.team_memberships.length === 0"
                    ...
                    <ul v-else class="mt-3 space-y-3">
                        <li
                            v-for="m in profile.team_memberships"
                            :key="m.id"
                            class="flex items-center justify-between"
                        >
                            <a
                                :href="'/admin/organizaciones/' + m.team.slug"
                                class="text-sm text-card-foreground hover:text-[#2D6A4F]"
                                >{{ m.team.name }}</a
                            >
                            <span
