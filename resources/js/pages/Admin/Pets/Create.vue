  ...
  <div>
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-muted-foreground">Registra una nueva mascota en la plataforma.</p>
      </div>
    </div>
    ...
    <form @submit.prevent="submit" class="mt-6 max-w-2xl space-y-6">
      ...
      <div class="grid gap-2">
        ...
        />
        <div v-if="previewUrl" class="mt-2 overflow-hidden rounded-lg border border-border">
      ...
      <div class="flex items-center gap-4">
        ...
        <a href="/admin/mascotas" class="text-sm text-muted-foreground hover:text-foreground">Cancelar</a>
      </div>
    </form>
  </div>
</template>
