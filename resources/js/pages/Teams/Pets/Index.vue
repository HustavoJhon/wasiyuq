    ...
    <div>
        <div class="flex items-center justify-between">
            <div>
                ...
                <a
                    :href="`/${currentTeam?.slug}/mascotas/crear`"
                    ...
                    >
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                <a
                                    :href="`/${currentTeam?.slug}/mascotas/${pet.id}`"
                                    class="text-xs text-[#2D6A4F] hover:underline"
                                    >Ver</a
                                >
                                <a
                                    :href="`/${currentTeam?.slug}/mascotas/${pet.id}/editar`"
        ...
        <div v-if="meta.last_page > 1" class="mt-6 flex justify-center gap-2">
            <a
                ...
                :key="page"
                :href="`/${currentTeam?.slug}/mascotas?page=${page}`"
