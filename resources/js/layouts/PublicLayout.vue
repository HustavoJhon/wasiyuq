    ...
    <div class="flex min-h-screen flex-col bg-background">
            ...
            >
                ...
                >
                    <div class="flex items-center gap-2">
                        <a
                            href="https://wa.me/51944480535?text=Hola!%20Necesito%20soporte%20t%C3%A9cnico%20en%20Wasiyuq"
                            target="_blank"
                            class="flex h-8 w-8 items-center justify-center rounded-full text-[#2D6A4F] transition hover:bg-[#2D6A4F]/10"
                ...
                >
                    ...
                    <template v-if="$page.props.auth.user">
                        ...
                        <Link
                            ...
                            method="post"
                            as="button"
                            class="rounded-lg border border-border px-4 py-2 text-sm font-medium text-muted-foreground transition hover:bg-accent"
                            >Salir</Link
                        >
                    </template>
                    <template v-else>
        ...
        <footer class="border-t border-border/50 bg-muted/30">
            <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-2">
                            <li>
                                <a
                                    href="/mascotas"
                                    class="text-sm text-muted-foreground hover:text-[#2D6A4F]"
                                    >Mascotas</a
                                >
                            </li>
                            <li>
                ...
                <div
                    class="mt-8 border-t border-border/50 pt-8 text-center text-sm text-muted-foreground/70"
                >
                    <p>
                        &copy; {{ new Date().getFullYear() }} Wasiyuq. Todos los
                        derechos reservados.
                    </p>
                </div>
            </div>
