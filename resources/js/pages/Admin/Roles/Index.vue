    ...
    <div class="space-y-6">
        <div>
            ...
            <p class="mt-1 text-sm text-muted-foreground">
                Explora los diferentes roles disponibles y sus permisos
            </p>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-br from-[#2D6A4F]/5 to-transparent opacity-0 transition group-hover:opacity-100"
                />
                ...
                <div class="relative space-y-3">
                    ...
                    <!-- Stats -->
                    <div
                        class="border-t border-border/50 pt-2 text-xs text-muted-foreground/70"
                    >
                        {{ role.total_permissions }} permisos ·
                        {{ Object.keys(role.modules).length }} módulos
                    </div>
                </div>

                <!-- Arrow indicator -->
                <div
                    class="absolute right-4 bottom-4 text-[#2D6A4F]/50 transition group-hover:translate-x-1"
                >
                    <svg
                        class="h-4 w-4"
                        fill="none"
