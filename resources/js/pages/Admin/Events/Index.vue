        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Todos los eventos y campañas del sistema.
                </p>
            </div>
            <a
                ...
                >
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="mt-0.5 text-xs text-muted-foreground/60">{{ event.team.name }} · por {{ event.author.name }}</p>
                        </div>
                        <span
                    ...
                    <div class="mt-3 flex items-center gap-3 border-t border-border/50 pt-3">
                        <a :href="'/admin/eventos/' + event.id" class="text-xs font-medium text-[#2D6A4F] hover:text-[#1B4332] transition-colors">Ver</a>
                        <a :href="'/admin/eventos/' + event.id + '/editar'" class="text-xs font-medium text-muted-foreground hover:text-foreground transition-colors">Editar</a>
                        <button @click="destroy(event.id)" class="text-xs font-medium text-red-500 hover:text-red-700 transition-colors">Eliminar</button>
                    </div>
                </div>
            </div>
        </div>
